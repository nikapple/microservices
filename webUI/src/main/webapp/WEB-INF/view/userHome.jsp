...
<script src="${pageContext.request.contextPath}/javascript/getAllBooks.js"></script>
<script src="${pageContext.request.contextPath}/javascript/getUserActivities.js"></script>
<script src="${pageContext.request.contextPath}/javascript/updateActivity.js"></script>
</head>
